    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-12 text-center nopadding-right">
                <div class="top-logo">
                    <a href="{{URL::to('/trang-chu')}}"><img src="{{('public/frontend/img/logo.gif')}}" alt="" /></a>
                </div>
            </div>
            <!-- logo end -->
            <!-- mainmenu area start -->
                        ...
                        <div class="circle-shopping expand">
                            <div class="shopping-carts text-right">
                                ...
                                <div class="cart-toggler">
                                    ...
                                    <a href="#"><span class="cart-quantity">{{$content->count()}}</span></a>
                                </div>
                                    ...
                                    <ul class="cart-list">
                                        ...
                                        <li>
                                            ...
                                            <div class="small-cart-detail">
                                                <a class="remove" href="{{URL::to('/delete-to-cart/'.$v_content->rowId)}}"><i class="fa fa-times-circle"></i></a>
                                                <a href="#" class="edit-btn"><img src="{{('public/frontend/img/btn_edit.gif')}}" alt="Edit Button" /></a>
                                                <a class="small-cart-name" href="product-details.html">{{$v_content->name}}</a>
                                                <span class="quantitys"><strong>{{$v_content->qty}}</strong>x<span>{{number_format($v_content->price).' '.'vnđ'}}</span></span>
                                            </div>
                                        </li>
                                        @endforeach
                                    </ul>
                                    <p class="total">Tổng tiền: <span class="amount"><?php
