                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="cart-table">
                            ...
                            <tr>
                                <td>
                                    <a href="#"><img src="{{URL::to('public/upload/product/'.$v_content->options->image)}}" class="img-responsive" alt=""/></a>
                                </td>
                                <td>
            ...
            <div class="row">
                <div class="col-md-12 vendee-clue">
                    ...
                    <div class="shipping coupon cart-totals">
                        <ul>
                            <li class="cartSubT">Tổng: <span>{{number_format(Cart::subtotal()).' '.'vnđ'}}</span></li>
                            <li class="cartSubT">Phí ship:<span>0 vnđ</span></li>
                            <li class="cartSubT">Tổng thành tiền: <span>{{number_format(Cart::subtotal()).' '.'vnđ'}}</span></li>
                        </ul>
