            ...
            <div class="leftside-navigation">
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="{{URL::to('/add-sup')}}">Thêm nhà cung cấp</a></li>
                            <li><a href="{{URL::to('/all-sup')}}">Danh sách nhà cung cấp</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="javascript:;">
                        ...
                        <ul class="sub">
                            <li><a href="{{URL::to('/add-color')}}">Thêm màu</a></li>
                            <li><a href="{{URL::to('/all-color')}}">Danh sách màu</a></li>
                            <li><a href="{{URL::to('/add-size')}}">Thêm size</a></li>
                            <li><a href="{{URL::to('/all-size')}}">Danh sách size</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="javascript:;">
                        ...
                        <ul class="sub">
                            ...
                            <li><a href="{{URL::to('/add-product-detail')}}">Thêm sản phẩm chi tiết</a></li>
